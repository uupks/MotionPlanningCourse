...
{     
    ...
    ROS_INFO("[node] receive the planning target : [%f, %f, %f]\n", target_pt.x(), target_pt.y(), target_pt.z());
...
#define _use_jps 0
#if _use_jps
    {
        ...
        visVisitedNode(visited_nodes, _use_jps);
...
{   
    ...
    if (is_use_jps) {
        node_vis.ns = "demo_node/jps_expanded_nodes";
        node_vis.color.a = 0.45;
        node_vis.color.r = 1.0;
        node_vis.color.g = 0.0;
        node_vis.color.b = 0.0;
    } else {
        node_vis.ns = "demo_node/astart_expanded_nodes";
